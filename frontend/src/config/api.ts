// PUBLIC_API_URL is set at build time via .env file
// For production Docker, use the backend service name on the Docker network
const envApiUrl = (import.meta as any).env?.PUBLIC_API_URL;

// Use relative URL - requires Apache to proxy /api/* to backend
